...
pub enum Error {
    /// This error is thrown when a method is exported but has no binding method
    #[error("a valid binding method should be specified on method '{0}'")]
    MissingBindingMethod(String),
